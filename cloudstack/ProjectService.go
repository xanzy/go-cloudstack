...
type ActivateProjectResponse struct {
	...
	Tags                      []ActivateProjectResponseTags `json:"tags"`
...
type ActivateProjectResponseTags struct {
	Account      string `json:"account"`
...
type CreateProjectResponse struct {
	...
	Snapshottotal             int64                       `json:"snapshottotal"`
	State                     string                      `json:"state"`
	Tags                      []CreateProjectResponseTags `json:"tags"`
	Templateavailable         string                      `json:"templateavailable"`
	Templatelimit             string                      `json:"templatelimit"`
	Templatetotal             int64                       `json:"templatetotal"`
	Vmavailable               string                      `json:"vmavailable"`
...
type CreateProjectResponseTags struct {
	Account      string `json:"account"`
	Customer     string `json:"customer"`
	Domain       string `json:"domain"`
	Domainid     string `json:"domainid"`
...
type SuspendProjectResponse struct {
	...
	Snapshottotal             int64                        `json:"snapshottotal"`
	State                     string                       `json:"state"`
	Tags                      []SuspendProjectResponseTags `json:"tags"`
	Templateavailable         string                       `json:"templateavailable"`
	Templatelimit             string                       `json:"templatelimit"`
	Templatetotal             int64                        `json:"templatetotal"`
	Vmavailable               string                       `json:"vmavailable"`
...
type SuspendProjectResponseTags struct {
	Account      string `json:"account"`
	Customer     string `json:"customer"`
	Domain       string `json:"domain"`
	Domainid     string `json:"domainid"`
...
type UpdateProjectResponse struct {
	...
	Snapshottotal             int64                       `json:"snapshottotal"`
	State                     string                      `json:"state"`
	Tags                      []UpdateProjectResponseTags `json:"tags"`
	Templateavailable         string                      `json:"templateavailable"`
	Templatelimit             string                      `json:"templatelimit"`
	Templatetotal             int64                       `json:"templatetotal"`
	Vmavailable               string                      `json:"vmavailable"`
...
type UpdateProjectResponseTags struct {
	Account      string `json:"account"`
	Customer     string `json:"customer"`
	Domain       string `json:"domain"`
	Domainid     string `json:"domainid"`
