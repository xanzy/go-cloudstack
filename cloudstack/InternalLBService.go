...
type InternalLoadBalancerVM struct {
	...
	Nic                 []InternalLoadBalancerVMNic `json:"nic"`
...
type InternalLoadBalancerVMNic struct {
...
type StartInternalLoadBalancerVMResponse struct {
	...
	Name                string                                   `json:"name"`
	Networkdomain       string                                   `json:"networkdomain"`
	Nic                 []StartInternalLoadBalancerVMResponseNic `json:"nic"`
	Podid               string                                   `json:"podid"`
	Project             string                                   `json:"project"`
	Projectid           string                                   `json:"projectid"`
	Publicip            string                                   `json:"publicip"`
...
type StartInternalLoadBalancerVMResponseNic struct {
	Broadcasturi         string `json:"broadcasturi"`
	Deviceid             string `json:"deviceid"`
	Gateway              string `json:"gateway"`
	Id                   string `json:"id"`
...
type StopInternalLoadBalancerVMResponse struct {
	...
	Name                string                                  `json:"name"`
	Networkdomain       string                                  `json:"networkdomain"`
	Nic                 []StopInternalLoadBalancerVMResponseNic `json:"nic"`
	Podid               string                                  `json:"podid"`
	Project             string                                  `json:"project"`
	Projectid           string                                  `json:"projectid"`
	Publicip            string                                  `json:"publicip"`
...
type StopInternalLoadBalancerVMResponseNic struct {
	Broadcasturi         string `json:"broadcasturi"`
	Deviceid             string `json:"deviceid"`
	Gateway              string `json:"gateway"`
	Id                   string `json:"id"`
