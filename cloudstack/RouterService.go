...
type ChangeServiceForRouterResponse struct {
	...
	Nic                 []ChangeServiceForRouterResponseNic `json:"nic"`
...
type ChangeServiceForRouterResponseNic struct {
...
type DestroyRouterResponse struct {
	...
	Name                string                     `json:"name"`
	Networkdomain       string                     `json:"networkdomain"`
	Nic                 []DestroyRouterResponseNic `json:"nic"`
	Podid               string                     `json:"podid"`
	Project             string                     `json:"project"`
	Projectid           string                     `json:"projectid"`
	Publicip            string                     `json:"publicip"`
...
type DestroyRouterResponseNic struct {
	Broadcasturi         string `json:"broadcasturi"`
	Deviceid             string `json:"deviceid"`
	Gateway              string `json:"gateway"`
	Id                   string `json:"id"`
...
type RebootRouterResponse struct {
	...
	Name                string                    `json:"name"`
	Networkdomain       string                    `json:"networkdomain"`
	Nic                 []RebootRouterResponseNic `json:"nic"`
	Podid               string                    `json:"podid"`
	Project             string                    `json:"project"`
	Projectid           string                    `json:"projectid"`
	Publicip            string                    `json:"publicip"`
...
type RebootRouterResponseNic struct {
	Broadcasturi         string `json:"broadcasturi"`
	Deviceid             string `json:"deviceid"`
	Gateway              string `json:"gateway"`
	Id                   string `json:"id"`
...
type StartRouterResponse struct {
	...
	Name                string                   `json:"name"`
	Networkdomain       string                   `json:"networkdomain"`
	Nic                 []StartRouterResponseNic `json:"nic"`
	Podid               string                   `json:"podid"`
	Project             string                   `json:"project"`
	Projectid           string                   `json:"projectid"`
	Publicip            string                   `json:"publicip"`
...
type StartRouterResponseNic struct {
	Broadcasturi         string `json:"broadcasturi"`
	Deviceid             string `json:"deviceid"`
	Gateway              string `json:"gateway"`
	Id                   string `json:"id"`
...
type StopRouterResponse struct {
	...
	Name                string                  `json:"name"`
	Networkdomain       string                  `json:"networkdomain"`
	Nic                 []StopRouterResponseNic `json:"nic"`
	Podid               string                  `json:"podid"`
	Project             string                  `json:"project"`
	Projectid           string                  `json:"projectid"`
	Publicip            string                  `json:"publicip"`
...
type StopRouterResponseNic struct {
	Broadcasturi         string `json:"broadcasturi"`
	Deviceid             string `json:"deviceid"`
	Gateway              string `json:"gateway"`
	Id                   string `json:"id"`
